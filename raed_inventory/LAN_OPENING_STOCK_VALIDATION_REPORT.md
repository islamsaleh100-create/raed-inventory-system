...
**Generated:** 2026-06-16 12:16 UTC

## Verdict: **GO**

## Trial Branches Detected

- `BR-DM-ON-ARKAN` — Onda Arkan (id=9)
- `BR-DM-RN-KHOBR` — Ronaldos Al Khobar (id=19)
- `BR-DM-SH-KHOBR` — Shawarma Al Khobar (id=29)

## Trial Warehouse

- `WH-DM-1` — Dammam Central Warehouse (id=3)
